 ...
 */
final class Version20220329123627 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE siege ADD salle_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE siege ADD CONSTRAINT FK_6706B4F7DC304035 FOREIGN KEY (salle_id) REFERENCES salle (id)');
        $this->addSql('CREATE INDEX IDX_6706B4F7DC304035 ON siege (salle_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_6706B4F7DC304035 ON siege');
        $this->addSql('ALTER TABLE siege DROP salle_id');
    }
}
